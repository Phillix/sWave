...
function validateRegistration(ev) {
    ...
    if ($("usernameRegField").value === "")
        ...
        displayCustomAlert("Required Field 'Password' is Empty");
    else if ($("fnameRegField").value === "")
        displayCustomAlert("Required Field 'First Name' is Empty");
    else if ($("lnameRegField").value === "")
        displayCustomAlert("Required Field 'Last Name' is Empty");
        ...
        displayCustomAlert("First Name should be an uppercase letter followed by one or more lowercase letters");
    else if ($("lnameRegField").value !== "" && !lnameRegEx.test($("lnameRegField").value))
        displayCustomAlert("Last Name should be an uppercase letter followed by one or more upper or lowercase letters or spaces");
    else
        $("registerForm").submit();
}
